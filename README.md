Dự án phân tích toàn diện dữ liệu thương mại điện tử từ hệ sinh thái Olist (Brazil) với quy mô hơn 100,000 đơn hàng. Mục tiêu chính là tối ưu hóa tỷ lệ giữ chân khách hàng thông qua mô hình phân khúc RFM và xây dựng hệ thống gợi ý sản phẩm.
**Công cụ **
Language: Python 3.12+
Libraries: * Xử lý dữ liệu: Pandas, Numpy, Sqlite3
...
Data Visualization: Trực quan hóa mối quan hệ sản phẩm bằng Đồ thị mạng lưới (Network Graph).
